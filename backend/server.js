...
app.use(express.json({ limit: '50mb' }));  // Parse JSON bodies - increased for HD thumbnails
app.use(express.urlencoded({ extended: true, limit: '50mb' }));  // Increased for HD image uploads
